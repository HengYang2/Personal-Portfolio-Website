...
export default function responseModule(selectedQuestion) {
    switch (selectedQuestion) {
        case 'option1':
            return (["My name is Heng Yang, I'm a software developer who enjoys creating games, making music, and any kind of creative expression :^)", "I like building things, for example this world you see here! I guess you can say that you're looking into part of my mind right now!", 'Do you have any other questions?']); 
        case 'option2':
