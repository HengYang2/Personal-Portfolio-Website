...
export default function LaptopView(props) {
  ...
  //     return <iframe src='../../../../public/resume/tempResume.pdf#toolbar=0' className='absolute z-50 bg-red-500 h-100 w-100 ml-110 mt-111'></iframe>
    ...
    <>
      ...
      <div className='ml-96 w-full h-full absolute flex flex-col justify-center items-center'>
        <div className='flex flex-col gap-1 justify-center items-center bg-blue-400 h-1/3 w-1/5 z-20 border-black rounded-md border'>
          ...
          <a href='../../../../public/resume/tempResume.pdf' target='_blank' className='bg-white h-12 w-3/4  flex justify-center items-center border-black rounded-md border hover:border hover:border-white hover:text-white text-sm box-shadow button-hover-effect'>Resume</a>
          <a className='bg-white h-12 w-3/4  flex justify-center items-center border-black rounded-md border hover:border hover:border-white hover:text-white text-sm box-shadow button-hover-effect'>Send Email</a>
        </div>
      </div>
      <iframe src='../../../../public/resume/tempResume.pdf#toolbar=0' className='absolute z-50 bg-red-500 h-100 w-100 ml-110 mt-111'></iframe>
    </>
  )
}
